...
{  
    public:
        ...
        void next_circle(double TA,double H,double S,enum Edge_Pattern);
    ...
    private:
        ...
        SecParam Next_Circle[5]={
            ...
            {Section::TRACER,{60, 0.05, 48, 2.5, 5.0 ,0 , 0, _EDGE},Section::COLOR,{h,s, Section::RESETLEN}, Section::EMNONE,{}},
            {Section::WANONE,{},Section::JUNONE,{}, Section::EMNONE,{}}};
