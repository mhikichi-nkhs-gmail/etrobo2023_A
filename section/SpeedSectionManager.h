...
class SpeedSectionManager : public SectionManager {
    ...
    private:
        ...
        SecParam Rcourse[20] = {
           ...
           //{Section::VIRSLINE,{60, 0, 0, 75, 2.5 ,6.0},Section::LENGTH,{100, Section::RESETLEN}, Section::EMNONE,{}},/*RESETLEN*/
          // {Section::WALKER,{0,0},Section::TIME,{300, Section::FLNONE}, Section::EMNONE,{}},
            //{Section::VIRSLINE,{-60, 0, 0, 75, 2.5 ,6.0},Section::LENGTH,{-100, Section::RESETLEN}, Section::EMNONE,{}},/*RESETLEN*/
            //{Section::WALKER,{0,0},Section::TIME,{300, Section::FLNONE}, Section::EMNONE,{}},
            ...
            {Section::TRACER,{80, 0.1, 25, 5.0, 8.0 ,0 , 0, _EDGE},Section::LENGTH,{15, Section::RESETLEN}, Section::EMNONE,{}},
            //{Section::WALKER,{0,0},Section::TIME,{10, Section::FLNONE}, Section::EMNONE,{}},
            {Section::TRACER,{80, 0.1, 25, 5.0, 8.0 ,0 , 0, _EDGE},Section::COLOR,{208,0.05, Section::RESETLEN}, Section::EMNONE,{}},
