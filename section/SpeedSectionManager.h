...
class SpeedSectionManager : public SectionManager {
    ...
    private:
        ...
        SecParam Rcourse[20] = {
            //{Section::FILE,{0,0},Section::TIME,{500, Section::FLNONE}, Section::EMNONE,{}},
            //{Section::FILE,{0,1},Section::TIME,{1, Section::FLNONE}, Section::EMNONE,{}},
            //{Section::FILE,{3,1},Section::RECEPTION,{0,1000, Section::FLNONE}, Section::EMNONE,{}},
            //{Section::WALKER,{0,0},Section::TIME,{10000000, Section::RESETLEN}, Section::EMNONE,{}},
            {Section::TRACER,{80, 0, 25, 5.0, 8,0 , 0, _EDGE},Section::LENGTH,{290, Section::FLNONE}, Section::EMNONE,{}},
            ...
            {Section::TRACER,{80, 0, 25, 5.0, 8.0 ,0 , 0, _EDGE},Section::LENGTH,{165, Section::RESETLEN}, Section::EMNONE,{}},
